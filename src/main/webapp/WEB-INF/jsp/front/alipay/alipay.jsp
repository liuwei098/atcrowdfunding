...
<body text=#000000 bgColor="#ffffff" leftMargin=0 topMargin=4>
	...
	<div id="main">
		...
		<form name=alipayment action="alipay.trade.page.pay" method=post
			target="_blank">
			<div id="body1" class="show" name="divcontent">
				<dl class="content">
					<dt>商户订单号 ：</dt>
					<dd>
						<input id="WIDout_trade_no" name="WIDout_trade_no" value="${order.id }" />
					</dd>
					<hr class="one_line">
					<dt>订单名称 ：</dt>
					<dd>
						<input id="WIDsubject" name="WIDsubject" value="众筹网项目${order.project.name }"/>
					</dd>
					<hr class="one_line">
					<dt>付款金额 ：</dt>
					<dd>
						<input id="WIDtotal_amount" name="WIDtotal_amount" value="${order.money }" />
					</dd>
					<hr class="one_line">
					<dt>商品描述：</dt>
					<dd>
						<input id="WIDbody" name="WIDbody" value="众筹网项目${order.project.name }" />
					</dd>
					<hr class="one_line">
					<dt></dt>
					<dd id="btn-dd">
		...
		<form name=tradequery action=alipay.trade.query method=post
			target="_blank">
		...
		<form name=traderefund action=alipay.trade.refund method=post
			target="_blank">
		...
		<form name=tradeclose action=alipay.trade.close method=post
			target="_blank">
