              ...
              <ul class="nav navbar-nav navbar-right">
                ...
                <c:if test="${loginMember==null }">
                  ...
                  <a href="javascrpt:void(0)">
          			欢迎${loginMember.loginacct }
          			</a>
          			</c:if>
                </li>
                <li><a href="member_toreg">注册</a></li>
              </ul>
            </div>
			  </div>
			</nav>
...
<div class="container">
	<div class="row clearfix">
		<div class="col-md-12 column">
			...
			<div class="row">
				<c:forEach items="${type.projectList }" var="project">
				<div class="col-md-3">
					<div class="thumbnail">
						<a href="project?id=${project.id }"><img src="${project.titleimg }"></a>
						<div class="caption">
							<h3 class="break">
                            ...
                            <p>
                                ...
                                <div style="float:right;"><i title="截至日期" class="glyphicon glyphicon-calendar"></i>
                                 <fmt:formatDate value="${project.createtime }" pattern="yyyy-MM-dd HH:mm:ss"/> </div>
                            </p>
                            <br>
