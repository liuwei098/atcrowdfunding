...
public class TMember implements Serializable{
	 ...
	 * 
	 */
	private static final long serialVersionUID = 2558977549892479085L;
	/**
    ...
    /**
     * This field was generated by MyBatis Generator.
     * This field corresponds to the database column t_member.iconpath
     *
     * @mbggenerated Fri Aug 23 09:32:12 GMT+08:00 2019
     */
    ...
    private List<TProject> followProjects;
    private List<TProject> supportProjects;
    private List<TProject> addProjects;
    
    public List<TProject> getFollowProjects() {
		return followProjects;
	}

	public void setFollowProjects(List<TProject> followProjects) {
		this.followProjects = followProjects;
	}

	public List<TProject> getSupportProjects() {
		return supportProjects;
	}

	public void setSupportProjects(List<TProject> supportProjects) {
		this.supportProjects = supportProjects;
	}

	public List<TProject> getAddProjects() {
		return addProjects;
	}

	public void setAddProjects(List<TProject> addProjects) {
	...
	/**
     * This method was generated by MyBatis Generator.
     * This method returns the value of the database column t_member.iconpath
     *
     * @return the value of t_member.iconpath
     *
     * @mbggenerated Fri Aug 23 09:32:12 GMT+08:00 2019
     */
    ...
    /**
     * This method was generated by MyBatis Generator.
     * This method sets the value of the database column t_member.iconpath
     *
     * @param iconpath the value for t_member.iconpath
     *
     * @mbggenerated Fri Aug 23 09:32:12 GMT+08:00 2019
     */
	...
	public String getCutomtel() {
		return cutomtel;
	}

	public void setCutomtel(String customtel) {
		this.cutomtel = customtel;
	}

	@Override
	public String toString() {
		return "TMember [id=" + id + ", introduce=" + introduce + ", loginacct=" + loginacct + ", userpswd=" + userpswd
				+ ", username=" + username + ", email=" + email + ", authstatus=" + authstatus + ", usertype="
				+ usertype + ", realname=" + realname + ", cardnum=" + cardnum + ", accttype=" + accttype + ", tel="
				+ tel + ", iconpath=" + iconpath + ", describe1=" + describe1 + ", cutomtel=" + cutomtel + "]";
	}
